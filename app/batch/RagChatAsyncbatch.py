...
from features.chatbot.data.datasource.FaissLangchainVectorDbSource import (
    FaissLangchainVectorDbSource,
)
...
def process_batch(
    batch: List[Tuple[Awaitable[ChatRagReadModel], ChatRagPayloadModel]],
) -> None:
